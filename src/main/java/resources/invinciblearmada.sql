...
CREATE TABLE IF NOT EXISTS `invinciblearmada`.`match` (
  ...
  `team_home` INT NULL DEFAULT NULL,
  `team_away` INT NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `invinciblearmada`.`team_comment` (
  ...
  `team_comment` VARCHAR(200) NULL DEFAULT NULL,
  `team_commentcol` VARCHAR(45) NULL DEFAULT NULL,
  `team_comment_datatime` DATETIME NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`team_no`),
